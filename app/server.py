...
tool_schedule.register(mcp, _cluster)     # 教学安排与备课闭环 11 工具（PRD-C-213 + R7a get_plan_detail）🔴全打 C 线 :8090=传 _cluster，工具内 ensure_c() 懒登录
tool_qbank.register(mcp, _cluster)        # search_questions / get_question（题库读侧·备课圈料，PRD-C-213 R7a）🔴打 C 线 :8090
tool_lecture_read.register(mcp, _cluster) # list_lecture_docs / get_lecture_content（讲义读侧·据讲义出题，PRD-C-213 R7a）🔴打 C 线 :8090
